...
namespace TradeHub.OrderExecutionProvider.BlackwoodTests.Integration
{
    ...
    {
        private BlackwoodOrderExecutionProvider _executionProvider;
        [SetUp]
        public void SetUp()
        {
            _executionProvider = ContextRegistry.GetContext()["BlackwoodOrderExecutionProvider"] as BlackwoodOrderExecutionProvider;
        }
        ...
        {
            MarketOrder marketOrder = new MarketOrder (Constants.OrderExecutionProvider.Blackwood)
                {
                    OrderID = "5000",
        ...
        {
            LimitOrder limitOrder = new LimitOrder(Constants.OrderExecutionProvider.Blackwood)
            {
                OrderID = "5000",
                Security = new Security { Symbol = "AAPL" },
